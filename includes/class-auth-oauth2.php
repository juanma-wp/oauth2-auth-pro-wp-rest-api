...
class Auth_OAuth2 {
	...
	public function register_routes(): void {
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'userinfo_endpoint' ),
				'permission_callback' => '__return_true',
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'refresh_token_endpoint' ),
				'permission_callback' => '__return_true',
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'logout_endpoint' ),
				'permission_callback' => '__return_true',
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'revoke_endpoint' ),
				'permission_callback' => '__return_true',
				'args'                => array(
					'token'           => array(
						'required' => true,
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'scopes_endpoint' ),
				'permission_callback' => '__return_true',
			)
		);
	...
	private function get_endpoint_required_scopes( string $route, string $method ): array {
		...
		$endpoint_scopes = array(
			...
			'POST:/wp/v2/users'          => array( 'manage_users' ),
			...
			'DELETE:/wp/v2/categories/*' => array( 'manage_categories' ),

			'GET:/wp/v2/tags'            => array( 'read' ),
			'POST:/wp/v2/tags'           => array( 'manage_categories' ),
			'PUT:/wp/v2/tags/*'          => array( 'manage_categories' ),
			'DELETE:/wp/v2/tags/*'       => array( 'manage_categories' ),
		);
